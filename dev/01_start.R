...
golem::fill_desc(
  ...
  repo_url = "https://github.com/nicjlambert/system-dynamics.git" # The URL of the GitHub Repo (optional) 
)     
...
usethis::use_mit_license( "Nicholas Lambert" )  # You can set another license here
